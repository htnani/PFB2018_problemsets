...
class dna_seq(object):
  ...
  def nucl_comp(self):
    ...
    GC_cont = round((G + C)/len(seq_string),2)
    comp = 'As:{}, Gs:{}, Cs:{}, Ts:{}, GC content:{}'.format(A, G, C, T, GC_cont)
    return comp

  def comparison(a,b):
   if a.seq_name == b.seq_name and a.sequence == b.sequence and a.seq_organism == b.seq_organism: return True
       #True
   else: return False
       #False
   #return 
...
print('a, b sequence are the same:',str(dna_seq.comparison(dna_seq_obj1, dna_seq_obj2)))
